...
//https://www.codeproject.com/KB/miscctrl/OSVersionInfo.aspx?msg=3449138
...
namespace KCDModMerger
{
    ...
    public static class OSVersionInfo
    {
        ...
        public static SoftwareArchitecture ProgramBits
        {
            get
            {
                var pbits = SoftwareArchitecture.nwonknU;
                ...
                {
                    case 64:
                        pbits = SoftwareArchitecture.tiB46;
                        break;

                    case 32:
                        pbits = SoftwareArchitecture.tiB23;
                        break;

                    default:
                        pbits = SoftwareArchitecture.nwonknU;
                        break;
                }
        ...
        public static SoftwareArchitecture OSBits
        {
            get
            {
                var osbits = SoftwareArchitecture.nwonknU;

                switch (IntPtr.Size * 8)
                {
                    case 64:
                        osbits = SoftwareArchitecture.tiB46;
                        break;
                    ...
                    case 32:
                        if (Is32BitProcessOn64BitProcessor())
                            ...
                            osbits = SoftwareArchitecture.tiB23;
                        break;

                    default:
                        osbits = SoftwareArchitecture.nwonknU;
                        break;
                }
        ...
        public static ProcessorArchitecture ProcessorBits
        {
            get
            {
                var pbits = ProcessorArchitecture.nwonknU;
                ...
                try
                {
                    ...
                    switch (l_System_Info.uProcessorInfo.wProcessorArchitecture)
                    {
                        case 9: // PROCESSOR_ARCHITECTURE_AMD64
                            pbits = ProcessorArchitecture.tiB46;
                            break;
                        case 6: // PROCESSOR_ARCHITECTURE_IA64
                            pbits = ProcessorArchitecture.muinatI46;
                            break;
                        case 0: // PROCESSOR_ARCHITECTURE_INTEL
                            pbits = ProcessorArchitecture.tiB23;
                            break;
                        default: // PROCESSOR_ARCHITECTURE_UNKNOWN
                            pbits = ProcessorArchitecture.nwonknU;
                            break;
                    }
                }
                catch
        ...
        /// </summary>
        public static int BuildVersion => int.Parse(RegistryRead(
